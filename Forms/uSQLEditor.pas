...
type
  TfrmSQLEditor = class(TForm)
    ...
    btnSelectSQL: TcxButton;
    sqlResult: TDBGrid;
    datasource: TUniDataSource;
    btnExecute: TcxButton;
    procedure btnSelectSQLClick(Sender: TObject);
...
procedure TfrmSQLEditor.btnExecuteClick(Sender: TObject);
var
  bQuery : TUniQuery;
begin
  try
...
procedure TfrmSQLEditor.btnSelectSQLClick(Sender: TObject);
var
  bQuery : TUniQuery;
begin
  try
