object frmSQLEditor: TfrmSQLEditor
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object txtSQLCode: TfsSyntaxMemo
    Left = 8
    Top = 8
    Width = 756
    Height = 385
    ...
    CommentAttr.Style = [fsBold, fsItalic]
    KeywordAttr.Charset = DEFAULT_CHARSET
    KeywordAttr.Color = clHotLight
  ...
  object btnSelectSQL: TcxButton
    ...
    OptionsImage.Glyph.Data = {
      ...
      0049454E44AE426082}
    TabOrder = 1
    OnClick = btnSelectSQLClick
  end
  object sqlResult: TDBGrid
    Left = 8
    Top = 408
    Width = 756
    Height = 145
